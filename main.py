    ...
    if request.method == 'POST':
        ...
        for file in files:
            if file and allowed_file(file.filename):
                ...
                enc_message = bytes('DROPOFF POD (AMQ)-- The following file was received: ' + file.filename + '', encoding='utf-8')
...
def api_upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        resp = jsonify({'message': 'This was not an approved file extension.'})
        resp.status_code = 400
        return resp
